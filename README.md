...
| 강성훈 | 코드변환 / 리팩토링 | 지금까지 백엔드 관련 프로젝트 진행해 오다가 Vue.js기반인 프론트 프로젝트를 진행하여 새로운 경험을 해 뜻깊은 시간이었습니다. 비록 프로젝트 과정에 팀원들에게 싫은 소리를 하였는데 돌이켜보면 죄송한 마음이지만 한 편으로는 감사하다는 마음도 생겼습니다. 제가 싫은 소리를 하고나서 열심히 해 주시는 모습 보고 저도 많은 것을 배웠고 보고 느꼈습니다.  |
